...
class HaresAndHoundsGUI(arcade.Window):
    ...
    def draw_same_columns_moves(self):
        arcade.draw_text("Self column moves:  " + str(self.game.sameColumnMoves), 180, 5, arcade.color.BLACK, 12)
    def draw_score(self):
        arcade.draw_text("Score:  " + str(self.score), 10, 300, arcade.color.BLUE, 16)
